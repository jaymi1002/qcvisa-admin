  ...
  <a-grid :cols="24" :row-gap="16" class="panel">
    <a-grid-item class="panel-col" :span="{ xs: 12, sm: 12, md: 12, lg: 12, xl: 12, xxl: 6 }">
      <a-space>
        ...
        <a-statistic title="录入订单数" :value="2" :value-from="0" animation show-group-separator>
          <template #suffix>
    ...
    <a-grid-item class="panel-col" :span="{ xs: 12, sm: 12, md: 12, lg: 12, xl: 12, xxl: 6 }">
      <a-space>
        ...
        <a-statistic title="被认领订单数" :value="368" :value-from="0" animation show-group-separator>
          <template #suffix>
